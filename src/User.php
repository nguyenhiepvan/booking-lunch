...
class User
{
    ...
    public function book_lunch($page): bool
    {
        try {
            ...
            $page->evaluate(JsFunction::createWithBody('document.querySelector(\'[title="' . $this->company . '"]\').click();'));
            //Select position
            $page->evaluate(JsFunction::createWithBody('document.querySelector(\'#canvas > div > div > div > div:nth-child(2) > div:nth-child(2) > div > app-dynamic-dropdown-control-form > div > div.drop-has-filter.ng-star-inserted > div.d-flex.flex-nowrap.align-items-center.form-control-group.background-component-main.w-100 > nz-select > nz-select-top-control > nz-select-item\').click();'));
